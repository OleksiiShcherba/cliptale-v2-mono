...
- Name: asset-manager.spec.ts >> Asset manager — panel and upload dropzone >> upload modal can be closed via the close button
- Location: e2e/asset-manager.spec.ts:81:7
