...
- Name: preview.spec.ts >> Preview panel — Remotion player and playback controls >> Remotion player container is present in the main area
- Location: e2e/preview.spec.ts:18:7
