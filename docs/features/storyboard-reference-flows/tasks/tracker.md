...
| T10 | Star gate в illustration service | app | Oleksii | M | T2, T3 | done |
...
| T21 | E2E: повна журні extract→confirm→stars→gate→scenes | tests | Oleksii | M | T5, T7, T11, T15, T16, T17, T18, T19, T20 | done |
