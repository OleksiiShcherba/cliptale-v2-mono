-- Migration: 02_add_history_origin_preview  (STAGED — feature-local ordinal; `implement`
-- promotes this into apps/api/src/db/migrations/ with the real number, next ≈ 051)
--
