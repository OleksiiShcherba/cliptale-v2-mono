...
describe('ExportModal', () => {
  ...
  it('renders a dialog with aria-label "Export video"', () => {
    render(<ExportModal versionId={10} projectId="test-project-001" onClose={onClose} />);
  ...
  it('renders a backdrop element with aria-hidden', () => {
    const { container } = render(<ExportModal versionId={10} projectId="test-project-001" onClose={onClose} />);
    const backdrop = container.querySelector('[aria-hidden="true"]');
    expect(backdrop).toBeTruthy();
  });

  it('passes versionId and projectId to useExportRender', () => {
    render(<ExportModal versionId={42} projectId="test-project-001" onClose={onClose} />);
    expect(mockUseExportRender).toHaveBeenCalledWith(42, 'test-project-001');
  });
