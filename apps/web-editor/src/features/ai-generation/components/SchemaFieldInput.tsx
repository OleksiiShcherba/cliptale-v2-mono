...
export interface SchemaFieldInputProps {
  ...
  /** Project id forwarded to AssetPickerField for image_url / image_url_list / audio_url types. */
  projectId: string;
}
 ...
 */
export function SchemaFieldInput({ field, value, onChange, projectId }: SchemaFieldInputProps) {
  const labelNode = (
