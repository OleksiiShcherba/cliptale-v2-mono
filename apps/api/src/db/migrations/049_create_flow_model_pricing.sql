-- 049 — flow_model_pricing: DB-adjustable, parameter-reactive pricing (ADR-0008, AC-20).
--
...
-- Rollback (staged): docs/features/generate-ai-flow/migrations/04_create_flow_model_pricing.down.sql
