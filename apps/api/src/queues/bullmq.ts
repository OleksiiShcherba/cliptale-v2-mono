...
export const QUEUE_STORYBOARD_OPENAI_IMAGE = 'storyboard-openai-image';
...
export const storyboardOpenAIImageQueue = new Queue(QUEUE_STORYBOARD_OPENAI_IMAGE, { connection });
