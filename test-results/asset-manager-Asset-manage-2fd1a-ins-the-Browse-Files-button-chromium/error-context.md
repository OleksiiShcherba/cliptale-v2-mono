...
- Name: asset-manager.spec.ts >> Asset manager — panel and upload dropzone >> upload modal contains the Browse Files button
- Location: e2e/asset-manager.spec.ts:74:7
