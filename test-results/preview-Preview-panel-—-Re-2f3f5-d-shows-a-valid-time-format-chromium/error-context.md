...
- Name: preview.spec.ts >> Preview panel — Remotion player and playback controls >> timecode display is present and shows a valid time format
- Location: e2e/preview.spec.ts:41:7
