...
- Name: preview.spec.ts >> Preview panel — Remotion player and playback controls >> clicking play changes the button aria-label to "Pause"
- Location: e2e/preview.spec.ts:29:7
