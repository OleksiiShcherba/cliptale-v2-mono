...
- Name: asset-manager.spec.ts >> Asset manager — panel and upload dropzone >> filter tabs are visible (All, Video, Audio, Image)
- Location: e2e/asset-manager.spec.ts:20:7
