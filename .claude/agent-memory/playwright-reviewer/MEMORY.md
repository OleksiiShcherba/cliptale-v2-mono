...
- [Known Working Workflows](workflows.md) — 21 confirmed user journeys in ClipTale editor (Epics 1-7 + Replace File dialog + Renders modal); includes Add to Timeline + createClip API and migration 007 issue
